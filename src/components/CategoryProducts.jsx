...
function CategoryProducts() {
  ...
  return (
    <section className="min-h-screen py-24 bg-[#0b0b0b]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-14">
          ...
          <p className="mt-5 text-gray-400 text-lg">
            Choose from our fresh and premium quality{" "}
        ...
        {filteredProducts.length === 0 ? (
          <div className="text-center py-20">
            ...
            <Link
              to="/products"
              className="inline-block mt-6 bg-red-600 hover:bg-red-500 text-white px-6 py-3 rounded-xl font-bold"
            >
              View All Products
            </Link>
          </div>
